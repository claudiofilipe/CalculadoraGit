...
public class Divisao {
	...
	//http://localhost:8080/div?a=1&b=2
	
	@GetMapping
	public ResponseEntity<Resultado> getDiv(@RequestParam(value ="a", required =false) float a1, @RequestParam(value ="b", required = false) float b1) {
