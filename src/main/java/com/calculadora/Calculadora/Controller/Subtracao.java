...
public class Subtracao {
	...
	//http://localhost:8080/sub?a=7&b=2
	
	@GetMapping
	public ResponseEntity<Resultado> getSub(@RequestParam(value ="a", required =false) float a1, @RequestParam(value ="b", required = false) float b1) {
